...
export class NorthKundaliVariant2 extends KundaliVariant {
    ...
    setup() {
        ...
        this.geometry['d1'] = Point.section(this.geometry['vA'], this.geometry['center'], 5, 5);
        this.geometry['d2'] = Point.section(this.geometry['vB'], this.geometry['center'], 5, 5);
        this.geometry['d3'] = Point.section(this.geometry['vC'], this.geometry['center'], 5, 5);
        this.geometry['d4'] = Point.section(this.geometry['vD'], this.geometry['center'], 5, 5);
    }
        ...
        this.shapes = [
            {
                ...
                planet: {
                    type: "grid",
                    center: Point.section(this.geometry["mTop"], this.geometry["center"], 10, 9),
                }
            },
            {
                name: 2,
                label: Point.section(this.geometry['d1'], this.geometry['mAT'], 2, 7),
                ...
                planet: {
                    type: "grid",
                    center: Point.section(Point.section(this.geometry["mAT"], this.geometry["mTop"], 2, 7), this.geometry["d1"], 5, 13)
                }
            },
            {
                name: 3,
                ...
                planet: {
                    type: "line",
                    center: Point.section(this.geometry["vA"], this.geometry["mLeft"], 11, 7)
                }
            },
            {
                name: 4,
                ...
                planet: {
                    type: "line",
                    center: Point.section(this.geometry["mLeft"], Point.mid(this.geometry["d1"], this.geometry["d4"]), 7, 3)
                }
            },
            {
                name: 5,
                ...
                planet: {
                    type: "line",
                    center: Point.section(this.geometry["vD"], this.geometry["mLeft"], 8, 7)
                }
            },
            {
                name: 6,
                ...
                planet: {
                    type: "grid",
                    center: Point.section(Point.section(this.geometry["mDB"], this.geometry["mBottom"], 2, 7), this.geometry["d4"], 5, 13)
                }
            },
            {
                name: 7,
                ...
                planet: {
                    type: "grid",
                    center: Point.section(this.geometry["mBottom"], this.geometry["center"], 10, 9)
                }
            },
            {
                name: 8,
                ...
                planet: {
                    type: "grid",
                    center: Point.section(Point.section(this.geometry["mCB"], this.geometry["mBottom"], 2, 7), this.geometry["d3"], 5, 13)
                }
            },
            {
                name: 9,
                ...
                planet: {
                    type: "line",
                    center: Point.section(this.geometry["vC"], this.geometry["mRight"], 8, 7),
                    align: "right",
                }
            },
            {
                ...
                planet: {
                    type: "line",
                    center: Point.section(this.geometry["mRight"], Point.mid(this.geometry["d2"], this.geometry["d3"]), 7, 3),
                    align: "right",
                }
            },
            {
                ...
                planet: {
                    type: "line",
                    center: Point.section(this.geometry["vB"], this.geometry["mRight"], 11, 7),
                    align: "right",
                }
            },
            {
                ...
                planet: {
                    type: "grid",
                    center: Point.section(Point.section(this.geometry["mBT"], this.geometry["mTop"], 1, 7), this.geometry["d2"], 5, 13)
                }
            },
        ];
    }

    getShapeCommands(vertex: Point, moveTo: Point, lineTo: Point, closeTo?: Point): CmdTuple[] {
